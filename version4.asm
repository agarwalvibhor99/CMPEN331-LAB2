...
loop:
	...
	#this exit eequence can be used with QtSPIM, but not with MARS
# 	mov $v0, $0				#return status 0
...
# Wrapper fucntiosn aroudn some of the system calls
