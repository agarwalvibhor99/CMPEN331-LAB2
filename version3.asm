...
main:
	...
	jal Exit0				# end the program, default returns status
...
Print_integer: # print the integer in register $a0
	...
	.globl Print_string
Print_string:					# print the string whose starting address is %a0
	li $v0, 4
	syscall
	jr $ra
...
Exit0:							# end the program, default return status
	...
	.globl Exit2
Exit2:							# end the program, with the return status from register $a0
	li $v0, 17
	syscall
	jr $ra						# this instruction is never executed
